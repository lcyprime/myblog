var Pagination = {
	...
	//	html.push("<span class=\"total total_page\">共" + pageCount + "页</span>");
		if(pageCount>7) {
			html.push("<span class=\"page_jump\">到</span><input id='pageInput' class='pageInput' onkeyup=\"value=value.replace(/[^\\d]/g,'')\" oldpage='' maxlength='" + pageCount + "' type='text' ><span class=\"page_jump\">页</span><button type='button' id='pagebtn' class='pagebtn'>确定</button>");
		}
		return html.join("");
	},
