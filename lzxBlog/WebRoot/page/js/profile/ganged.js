...
;(function($) {
	...
	function handleData(datas) {
		...
		var tempCities = [];
		var tempAreas = [];
		var reProvince = /^[0-9]{2}0{4}$/;
		var reCity = /^[0-9]{4}0{2}$/;
		var reArea = /^[0-9]{6}$/;
	...
	function showProvince(obj, selectPId) {
		...
		if(moProvinceStr != "" && moProvinceId != ""){
			tempStr = '<a href="javascript:void(0);" val="'+ moProvinceId +'">'+moProvinceStr+'</a>';
			tempId = moProvinceId;
			tempName = moProvinceStr;
		}
		...
		$(obj).find('div[name="province"]').inputbox({
	...
	function showCity(obj, cities, selectCId) {
		...
		if(moCityStr != "" && moCityStrId != ""){
			tempStr = '<a href="javascript:void(0);" val="'+ moCityStrId +'">'+moCityStr+'</a>';
			tempId = moCityStrId;
			tempName = moCityStr;
		}
	...
	function showArea(obj, areas, selectAId) {
		...
		if(moAreaStr != "" && moAreaStrId != ""){
			tempStr = '<a href="javascript:void(0);" val="'+ moAreaStrId +'">'+moAreaStr+'</a>';
			tempId = moAreaStrId;
			tempName = moAreaStr;
		}
